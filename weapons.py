...
#       "reload"           : float
#       "trigger_type"     : str          ("auto", "semi", "held", "charge", "burst"; default "auto")
#       "charge_time"      : float        (default 0.0)
#       "burst_count"      : int          (default 1)
#       "burst_delay"      : float        (default 0.0)
#       "ammo_cost_per_shot": float       (default 1.0)
